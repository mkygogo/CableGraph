...
def line_detect(image_path, label_path):
        
    print(f"Running inference on {image_path}...")
    predicted_connections, saved_image_path = predict_links(
            image_path, label_path, model, vocab, DEVICE
        )
...
if __name__ == "__main__":
        # --- 指定要推理的图像 ---
    FILE = "IMG_20251022_114142_resized"
    image = f"files/{FILE}.jpg"
    label = f"output_jsons/{FILE}.json"
    line_detect(image, label)
